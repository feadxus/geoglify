...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <v-form @submit.prevent="updateRole">
            <v-card
                class="mx-auto pa-3"
                :title="$t('global.roles.edit_title')"
            ...
            >
                <v-card-text>
                    ...
                    <v-text-field
                        ...
                        :label="$t('global.common.fields.description')"
                        variant="outlined"
                        :error-messages="form.errors.description"
                    />

                    <v-card
                        :title="$t('global.roles.permissions')"
                        :subtitle="
                        ...
                        "
                        variant="outlined"
                        :color="form.errors.permissions ? 'red' : ''"
                        :style="
                            form.errors.permissions
                                ? ''
                ...
                <v-card-actions class="px-4">
                    ...
                    <v-btn
                        v-if="$page.props.auth.can.roles_edit"
                        type="submit"
                        color="primary"
                        variant="flat"
                        class="mt-4"
