    ...
    <AuthLayout>
        ...
        <form @submit.prevent="submit" class="mt-7 loginForm">
            <div class="mb-5">
                ...
                <v-text-field v-model="form.name" :error-messages="form.errors.name" class="mt-2" required
                    hide-details="auto" variant="outlined" color="primary" autocomplete="name"
            ...
            <div class="mb-5">
                ...
                <v-text-field v-model="form.password" :error-messages="form.errors.password" required variant="outlined"
                    ...
                    autocomplete="new-password" placeholder="*****" :append-inner-icon="showPassword ? 'mdi-eye-off' : 'mdi-eye'
            ...
            <div class="mb-5">
                ...
                <v-text-field v-model="form.password_confirmation" :error-messages="form.errors.password_confirmation"
                    ...
                    :type="showPassword ? 'text' : 'password'" class="mt-2" autocomplete="new-password"
